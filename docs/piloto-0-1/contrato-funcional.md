...
| ~~B8~~ | ~~**M7** — responsable y versionado del contrato~~ — **resuelto** el 2026-09-21 por [ADR 0026](../adr/0026-gobernanza-y-cierre-de-m7.md) §9. El rol `Contract Owner Materiales–ELSA` tiene ocupante asignado y gobernanza materializada en el repositorio de Materiales, que es su **fuente canónica única**; ELSA la referencia y **no registra nombre ni contacto**. El **versionado del contrato sigue siendo M1** y permanece en **B4** | — |
...
> **Resultado, 2026-09-19.** La muestra fue de **30 códigos distintos**, el
...
| **M1, M4, M6** | Sus estados se mantienen en sus artefactos y decisiones correspondientes, **sin cambio**. Ninguno se cierra por asociación con M3, M5 ni M7. **Este apartado no los redefine** |
| ~~**M7** — responsable y versionado del contrato~~ | **Cerrado** el 2026-09-21 por [ADR 0026](../adr/0026-gobernanza-y-cierre-de-m7.md) §9. Ocupante asignado y gobernanza materializada en el repositorio de Materiales, fuente canónica única de la asignación. Deja de ser una decisión abierta. **No arrastra a M1**, que sigue abierto y bloqueante: cerrar M7 es **condición previa** para solicitar la fachada ([ADR 0026](../adr/0026-gobernanza-y-cierre-de-m7.md) §8), no autorización para solicitarla |
